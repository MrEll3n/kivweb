        ...
        <div class="flex md:flex-row flex-col flex-shrink-0 h-full rounded flex-grow">
            ...
            <div class="flex flex-col flex-grow">
                <div class="flex flex-col h-5/6 px-4 pt-4 pb-2 flex-grow">
                    <h2 class="font-dosis-bold dark:text-neutral-100 text-neutral-800 text-3xl px-3 pb-2 border-b border-neutral-800 dark:border-neutral-300 break-all">{{ header }}</h2>
