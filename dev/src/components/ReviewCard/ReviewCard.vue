...
<template>
    <div class="flex md:flex-row flex-col flex-shrink-0 h-full border dark:border-neutral-300 border-neutral-800 dark:bg-black bg-gray-50 h1/4 md:h-[24rem] z-10 rounded">
        <div class="flex md:flex-shrink-0 w-full md:w-80 justify-center sm:border-b md:border-b-0 md:border-r dark:border-neutral-300 border-neutral-800">
            <img v-if="article_image == null" src="/src/assets/images/news-holder.jpg" alt="news_image" />
            <img v-else-if="true" :src="`/src/assets/images/${article_image}`" alt="news_image">
        </div>
        <div class="flex flex-col">
            <div class="flex flex-col h-5/6 px-4 pt-4 pb-2">
                ...
                <p class="font-dosis-regular dark:text-neutral-100 text-neutral-800 text-md px-3 pt-2 line-clamp-5 md:line-clamp-6">{{ article_content }}</p>
            </div>
            <div class="flex flex-col md:flex-row justify-between m-4 flex-wrap gap-4">
                ...
                <div>
                    <div class="flex fled-row mx-2 gap-2 flex-wrap">
                        <RouterLink :to="`reviews/${article_id}`"><MonoButton class="z-50"> Accept </MonoButton></RouterLink>
